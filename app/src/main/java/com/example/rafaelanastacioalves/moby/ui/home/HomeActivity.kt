package com.example.rafaelanastacioalves.moby.ui.home
...
import com.example.rafaelanastacioalves.moby.ui.articledetail.ArticleDetailActivity
...
class HomeActivity : AppCompatActivity(), RecyclerViewClickListener {
    ...
    private fun generateData(): List<HomeItemData> {
        ...
        list.add(HomeItemData("Expand/Collapse Item Demonstration", "Item expansion/collapse animation effect", Intent(this, MainActivity::class.java)))
        return list
    }
